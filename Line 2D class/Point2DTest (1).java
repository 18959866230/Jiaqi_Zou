...
/**
 * This is the class used to test the methods in Point2D class, includes corner
 * case and normal case for each test.
 * 
 * @author Jiaqi Zou
 * @version Feb 11, 2023
 *
...
public class Point2DTest {
	...
	public void testCopyOf() {
		...
		Point2D p2 = p1.copyOf();
		assertNotSame(p1, p2);
		assertEquals(p1.getX(), p2.getX(), 0.0);
	...
	public void testAdd() {
		...
		assertEquals(4.0, p3.getX(), 0.0);
		assertEquals(6.0, p3.getY(), 0.0);
	}
	...
	public void testAdd2() {
		...
		Point2D p3 = p1.add(p2);
		assertEquals(6, p3.getX(), 0.0001);
		assertEquals(8, p3.getY(), 0.0001);
	}
	...
	public void testAdd3() {
		...
		Point2D p3 = p1.add(p2);
		assertEquals(-3.0, p3.getX(), 0.0);
		assertEquals(2.0, p3.getY(), 0.0);
	}
	...
	public void testMidpoint() {
		Point2D p1 = new Point2D(1, 2);
		Point2D p2 = new Point2D(3, 4);
		Point2D p3 = p1.midpoint(p2);
		assertEquals(2.0, p3.getX(), 0.0);
		assertEquals(3.0, p3.getY(), 0.0);
	}
	...
	public void testMidpoint2() {
		...
		assertEquals(4, midpoint.getX(), 0.0001);
		assertEquals(3, midpoint.getY(), 0.0001);
	}
	...
	public void testMidpoint3() {
		...
		Point2D p2 = new Point2D(3, -4);
		Point2D p3 = p1.midpoint(p2);
		assertEquals(1.0, p3.getX(), 0.0);
		assertEquals(-1.0, p3.getY(), 0.0);
	}

	@Test
	public void testMidpoint4() {
		Point2D p1 = new Point2D(0, 0);
		Point2D p2 = new Point2D(0, 0);
		Point2D p3 = p1.midpoint(p2);
		assertEquals(0.0, p3.getX(), 0.0);
