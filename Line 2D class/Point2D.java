...
public class Point2D {
	...
	/**
	 * This method creates and returns a new, distinct Point2D object with data
	 * copied from this Point2D object.
	 * 
	 * @param none
	 * @return a new, distinct Point2D object with data copied from this Point2D
	 *         object
	 */
	...
	/**
	 * This method creates and returns a new, distinct Point2D object that is the
	 * sum of this Point2D object and the Point2D object referenced by other. For
	 * example, the sum of points (1, 2) and (3, 4) is a new point (4, 6).
	 * 
	 * @param other
	 * @return a new, distinct Point2D object that is the sum of this Point2D object
	 *         and the Point2D object referenced by other
	 */
	...
	/**
	 * This method creates and returns a new, distinct Point2D object that is the
	 * midpoint of the line segment formed by this Point2D object and the Point2D
	 * object referenced by other.
	 * 
	 * @param other
	 * @return a new, distinct Point2D object that is the midpoint of the line
	 *         segment formed by this Point2D object and the Point2D object
	 *         referenced by other.
	 */
	public Point2D midpoint(Point2D other) {
		int midpointX = (this.x + other.getX()) / 2;
		int midpointY = (this.y + other.getY()) / 2;
		return new Point2D(midpointX, midpointY);
